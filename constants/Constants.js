...
export const EULATexts = {
    LN1: `SD Line 1`,
    LN2: `The users need to utilise the information provided in the site`,
    LN3: `SD Line 3`,
    LN4: `Content provided in or through the site:`,
    LN5: `SD line 5`,
    LN6: `SD line 6`,
    LN7: `Stadom reserves the right to change, modify or discontinue any aspect of the Website at any time, including any information or its contents or features. Stadom reserves the right to collect, analyze and disseminate the patterns of usage of the Website by all its Users.`,
    LN8: `SD line 7`,
    H1: `SD H1`,
    H2: `Content`,
    H3: `Cookies`,
    H4: `External Links`,
    H5: `Stardom rights Rights`,
    ...
    PT3: `The user information available in this website is made available to us by the user and its purely the user's right to continue or to withdraw any information available at any point of time.`,
    PT4: `We are not responsible for any inaccuracy in the information available on the website.`,
    PT5: `We are not responsible for any misuse of contact information displayed in the website. If you feel that your contact details are being misused then contact us on support@stardom.wallpiper.app`
}