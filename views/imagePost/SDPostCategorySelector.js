    ...
    return (
        <View style={[{ maxHeight: height / numericConstants.ONEPTONE }, SDGenericStyles.alignItemsCenter]}>
            <View style={[SDGenericStyles.alignItemsCenter, SDGenericStyles.paddingTop20]}>
                ...
                <Text style={[SDGenericStyles.ft14, SDGenericStyles.placeHolderTextColor, SDGenericStyles.fontFamilyRobotoRegular, SDGenericStyles.paddingTop10,
            ...
            <Animated.ScrollView horizontal nestedScrollEnabled={true}>
                <FlatList data={props.categories} numColumns={numericConstants.THREE}
                    ...
                    ListFooterComponent={<Text style={[SDGenericStyles.ft16, userAuthStyles.formInputError, SDGenericStyles.fontFamilyRobotoMedium, SDGenericStyles.mt5]}>
