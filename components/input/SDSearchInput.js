...
import { keyBoardTypeConst, miscMessage, stringConstants } from '../../constants/Constants';
...
export const SDSearchInput = props => {
    return (
        <TextInput value={props.searchValue} textContentType={keyBoardTypeConst.NONE} placeholder={props.placeHolderText} clearButtonMode={miscMessage.ALWAYS}
            ...
            style={[userAuthStyles.searchTextInputStyle, props.extraStyles]} onChangeText={value => onChangeByValueType(stringConstants.EMPTY, value, props)} />
    )
}