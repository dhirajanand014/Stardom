...
export const LoginSecretIcon = () => {
    return (<Svg width={numericConstants.EIGHTEEN} height={numericConstants.EIGHTEEN} viewBox="0 0 24 24" fill={miscMessage.NONE} strokeWidth={numericConstants.TWO} stroke="#000000" strokeLinecap="round"
