...
export const MaleIcon = props => {
	return (<Svg x="0px" y="0px" width={numericConstants.FIFTY} height={numericConstants.FIFTY} viewBox="0 0 400.613 400.613"
		style="enable-backGround:new 0 0 400.613 400.613;" fill={props.fill} strokeWidth={numericConstants.TWO} stroke={props.stroke} strokeLinecap="round"
