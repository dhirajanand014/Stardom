...
export const FemaleIcon = props => {
    return (<Svg x="0px" y="0px" width={numericConstants.FIFTY} height={numericConstants.FIFTY} viewBox="0 0 31.259 31.259"
        style="enable-background:new 0 0 31.259 31.259;" fill={miscMessage.NONE} strokeWidth={numericConstants.TWO} stroke={props.stroke} strokeLinecap="round">
        <G>
